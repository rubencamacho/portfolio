...
x-show="open" class="relative z-10" aria-labelledby="slide-over-title" x-ref="dialog" aria-modal="true" style="display:none">
                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    ...
                    <div class="relative mt-6 flex-1 px-4 sm:px-6">
                        <div class="w-full sm:max-w-md px-6 py-4">
                            ...
                            {{-- Propiedad de Livewire --}}
                            <input type="hidden" wire:property="openSlideOver" />
                        </div>
                    </div>
                </div>
            </div>
